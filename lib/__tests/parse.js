...
describe('parse', () => {
    ...
    describe('positions', () => {
        ...
        it.only('should calculate location of layer correctly', () => {
            const positions = [];
            const ast = parse('@import "foo.css" layer(bar);\n@layer bar {}', {
                positions: true
            });
            ...
            assert.deepStrictEqual(positions, [
                [0, 1, 1, 43, 2, 14, 'StyleSheet'],
                [0, 1, 1, 29, 1, 30, 'Atrule'],
                [8, 1, 9, 28, 1, 29, 'AtrulePrelude'],
                [8, 1, 9, 17, 1, 18, 'String'],
                [18, 1, 19, 28, 1, 29, 'Function'],
                [24, 1, 25, 27, 1, 28, 'Layer'],
                [31, 2, 1, 43, 2, 14, 'Atrule'],
                [38, 2, 8, 41, 2, 11, 'AtrulePrelude'],
                [38, 2, 8, 41, 2, 11, 'LayerList'],
                [38, 2, 8, 41, 2, 11, 'Layer'],
                [42, 2, 12, 43, 2, 14, 'Block']
            ]);
        });
    });
});
