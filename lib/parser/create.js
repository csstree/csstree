const OffsetToLocation = require('../tokenizer/OffsetToLocation');
const TokenStream = require('../tokenizer/TokenStream');
const List = require('../common/List');
const SyntaxError = require('./SyntaxError');
const tokenize = require('../tokenizer');
const { consumeNumber, findWhiteSpaceStart, cmpChar, cmpStr } = require('../tokenizer/utils');
