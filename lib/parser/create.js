...
module.exports = function createParser(config) {
    var parser = {
        ...
        error: function(message, offset) {
            var location = typeof offset !== 'undefined' && offset < this.scanner.source.length
                ? this.scanner.getLocation(offset)
                : this.scanner.eof
                    ? this.scanner.getLocation(findWhiteSpaceStart(this.scanner.source, this.scanner.source.length - 1))
                    : this.scanner.getLocation(this.scanner.tokenStart);
    ...
    return function(source, options) {
        ...
        parser.scanner.setStart(options.offset, options.line, options.column);
