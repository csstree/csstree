        ...
        switch (this.scanner.tokenType) {
            ...
            default:
                ...
                if (this.scanner.tokenType === IDENTIFIER &&
                    this.scanner.lookupValue(0, 'u')) {
                    if (
                        this.scanner.lookupType(1) === PLUSSIGN || (
                            this.scanner.lookupType(1) === NUMBER &&
                            cmpChar(this.scanner.source, this.scanner.tokenEnd, PLUSSIGN)
                       )) {
