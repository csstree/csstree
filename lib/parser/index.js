...
module.exports = function createParser(config) {
    var parser = {
        ...
        parseChildren: function(type, name) { // name -> functions dict?
            return config.parseChildren[type].call(this, name);
        },
        recognizeChild: function(type) {
            return config.recognizeChild[type].call(this);
        },
    ...
    for (var key in config) {
        if (key !== 'parseChildren' && key !== 'recognizeChild') {
