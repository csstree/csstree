...
Syntax.prototype = {
    ...
    match: function(property, value) {
        ...
        if (!result || !result.match) {
            throw new MatchError('Mismatch', this.properties[property].syntax, value, result.next);
        } else if (result.next) {
            throw new MatchError('Uncomplete match', this.properties[property].syntax, value, result.next);
        }
