...
function createSyntax(config) {
    ...
    if (config.node) {
        for (var name in config.node) {
            ...
            if (typeof nodeType.parseChildren === 'function') {
                parser.parseChildren[name] = nodeType.parseChildren;
            }
            if (typeof nodeType.recognizeChild === 'function') {
                parser.recognizeChild[name] = nodeType.recognizeChild;
            }
