...
var MatchError = function(message, syntax, value, badNode) {
    ...
    error.css = css;
    error.line = badNode && badNode.info && badNode.info.start ? badNode.info.start.line : undefined;
    error.column = badNode && badNode.info && badNode.info.start ? badNode.info.start.column : undefined;
