...
function checkTokenIsInteger(scanner, disallowSign) {
    ...
    for (; pos < scanner.tokenEnd; pos++) {
        if (!isDigit(scanner.source.charCodeAt(pos))) {
            this.error('Unexpected input', pos);
        }
    }
}
...
module.exports = {
    ...
    parse: function() {
        ...
        if (this.scanner.tokenType === NUMBER ||
            ...
            checkTokenIsInteger.call(this, this.scanner, ALLOW_SIGN);
        ...
        if (this.scanner.tokenType === IDENTIFIER) {
            ...
            if (cmpChar(this.scanner.source, bStart, HYPHENMINUS)) {
                if (prefix === '') {
                    ...
                    this.error('Unexpected hyphen minus');
                }
            }
            ...
            if (len > 1) {
                ...
                if (this.scanner.source.charCodeAt(bStart + 1) !== HYPHENMINUS) {
                    this.error('Unexpected input', bStart + 1);
                }
                ...
                checkTokenIsInteger.call(this, this.scanner, DISALLOW_SIGN);
                ...
                if (this.scanner.tokenType === NUMBER) {
                    checkTokenIsInteger.call(this, this.scanner, prefix !== '');

                    if (!isDigit(this.scanner.source.charCodeAt(this.scanner.tokenStart))) {
