...
module.exports = {
    ...
    parse: function() {
        ...
        if (parseValue) {
            ...
            value = this.parseWithFallback(this.Value, consumeRaw);
            ...
            if (value.type !== 'Raw' &&
                ...
                value = consumeValueRaw.call(this, startValueToken);
            }
        } else {
    ...
    validate: function(node, warn) {
        ...
        if (!Object.prototype.hasOwnProperty.call(this.defs.Declaration, name.toLowerCase())) {
