...
function scanUnicodeRange(scanner) {
    ...
    scan: {
        ...
        if (scanner.tokenStart === hexStart) {
            this.error('Unexpected input', hexStart);
        }
    }
    ...
    for (var i = hexStart, wasHyphenMinus = false; i < scanner.tokenStart; i++) {
        ...
        if (isHexDigit(code) === false && (code !== HYPHENMINUS || wasHyphenMinus)) {
            this.error('Unexpected input', i);
        }
        ...
        if (code === HYPHENMINUS) {
            ...
            if (hexLength > 6) {
                this.error('Too long hex sequence', i);
            }
        }
    ...
    if (hexLength === 0) {
        this.error('Unexpected input', i - 1);
    }
...
module.exports = {
    ...
    parse: function() {
        ...
        scanUnicodeRange.call(this, this.scanner);
