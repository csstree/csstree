...
function fromMatchResult(matchResult) {
    ...
    const node = longestMatch < tokens.length ? tokens[longestMatch].node || null : null;
...
const SyntaxMatchError = function(message, syntax, node, matchResult) {
    ...
    const mismatchOffset = details.mismatchOffset;
    const mismatchLength = details.mismatchLength;
    const badNode = details.node;
