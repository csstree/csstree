...
function scanString(tokenizer) {
    ...
    if (end === -1) {
        error(tokenizer, tokenizer.str.length, 'Expect an apostrophe');
    }
...
function peek(tokenizer) {
    ...
    switch (code) {
        ...
        case LEFTCURLYBRACKET:
            ...
            // check first char isn't a number, because it's likely a disjoined multiplier
            var code = tokenizer.nextNonWsCode(tokenizer.pos + 1);
            if (code >= 48 && code <= 57) {
                break;
            }
