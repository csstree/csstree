var findIdentifierEnd = require('../tokenizer/utils').findIdentifierEnd;
var tokenConst = require('../tokenizer/const');
var SYMBOL_TYPE = tokenConst.SYMBOL_TYPE;
var IDENTIFIER = tokenConst.TYPE.Identifier;
var HYPHENMINUS = tokenConst.TYPE.HyphenMinus;
...
function customIdent(token, addTokenToStack) {
    ...
    if (findIdentifierEnd(token.value, 1) !== token.value.length) {
        return false;
    }
