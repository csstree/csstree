...
const cssWideKeywords = buildMatchGraph('inherit | initial | unset | revert | revert-layer');
const cssWideKeywordsWithExpression = buildMatchGraph('inherit | initial | unset | revert | revert-layer | <-ms-legacy-expression>');
