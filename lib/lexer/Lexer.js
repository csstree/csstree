...
Lexer.prototype = {
    ...
    matchValueFragments: function(propertyName, value, type, name) {
        return search.matchFragments(this, value, this.matchProperty(propertyName, value), type, name);
    },
    matchDeclarationValueFragments: function(declaration, type, name) {
        return search.matchFragments(this, declaration.value, this.matchDeclaration(declaration), type, name);
    },
    matchAllFragments: function(ast, type, name) {
        var result = [];

        this.syntax.walkDeclarations(ast, function(declaration) {
            result.push.apply(result, this.matchDeclarationValueFragments(declaration, type, name));
        }.bind(this));
