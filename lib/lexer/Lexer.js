const { SyntaxReferenceError, MatchError } = require('./error');
const names = require('../utils/names');
const generic = require('./generic');
const parse = require('../definition-syntax/parse');
const generate = require('../definition-syntax/generate');
const walk = require('../definition-syntax/walk');
const prepareTokens = require('./prepare-tokens');
const { buildMatchGraph } = require('./match-graph');
const { matchAsTree } = require('./match');
const trace = require('./trace');
const search = require('./search');
const { getStructureFromConfig } = require('./structure');
...
function dumpAtruleMapSyntax(map, compact, syntaxAsAst) {
    ...
    for (const [name, atrule] of Object.entries(map)) {
        result[name] = {
            ...
            descriptors: atrule.descriptors && dumpMapSyntax(atrule.descriptors)
        };
    }
