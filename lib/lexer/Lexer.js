...
Lexer.prototype = {
    structure: {},
    checkAst: function(ast, fn) {
        function collectWarning(node, error) {
            warns.push({
                node: node,
                error: error
            });
        ...
        this.syntax.walk(ast, function(node) {
            if (structure.hasOwnProperty(node.type)) {
                fn.call(lexer, structure[node.type], node, collectWarning);
            } else {
    ...
    checkStructure: function(ast) {
        return this.checkAst(ast, function(nodeType, node, collectWarning) {
            nodeType.check(node, collectWarning);
        });
    },
    checkValidity: function(ast) {
        return this.checkAst(ast, function(nodeType, node, collectWarning) {
            nodeType.validate.call(this, node, collectWarning);
        });
    },
